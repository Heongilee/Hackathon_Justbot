        ...
        $('.send_message').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (Parse_data) {
                    ...
                    let path_img = ''
                    if (dt1 == '1월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month1.png'
                    else if (dt1 == '2월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month2.png'
                    else if (dt1 == '3월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month3.png'
                    else if (dt1 == '4월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month4.png'
                    else if (dt1 == '5월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month5.png'
                    else if (dt1 == '6월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month6.png'
                    else if (dt1 == '7월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month7.png'
                    else if (dt1 == '8월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month8.png'
                    else if (dt1 == '9월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month9.png'
                    else if (dt1 == '10월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month10.png'
                    else if (dt1 == '11월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month11.png'
                    else if (dt1 == '12월 학사일정입니다.')
                        path_img = '../asset/calendar_img/month12.png'
                    /////////////////////////////////////////////////////////
                    // 교과 과정
                    ////////////////////////////////////////////////
                    else if (dt1 == '디자인 이노베이션학과 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/창의소프트웨어/디자인이노베이션교과과정.png'
                    else if (dt1 == '만화애니메이션학과 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/창의소프트웨어/만화애니메이션교과과정.png'
                    else if (dt1 == '정보보호학과 14년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/정보보호/정보보호14.png'
                    else if (dt1 == '정보보호학과 15년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/정보보호/정보보호15.png'
                    else if (dt1 == '정보보호학과 16년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/정보보호/정보보호16.png'
                    else if (dt1 == '정보보호학과 17년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/정보보호/정보보호17.png'
                    else if (dt1 == '정보보호학과 18년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/정보보호/정보보호18.png'
                    else if (dt1 == '데이터사이언스학과 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/데사/데사교과과정.png'
                    else if (dt1 == '소프트웨어학과 16년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/소웨/소웨16.png'
                    else if (dt1 == '소프트웨어학과 20년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/소웨/소웨20.png'
                    else if (dt1 == '지능기전공학과 스마트기기 17년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/17스마트.png'
                    else if (dt1 == '지능기전공학과 스마트기기 18년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/18스마트.png'
                    else if (dt1 == '지능기전공학과 스마트기기 19년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/19스마트.png'
                    else if (dt1 == '지능기전공학과 스마트기기 20년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/20스마트.png'
                    else if (dt1 == '지능기전공학과 무선이동체 17년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/17무선이동.png'
                    else if (dt1 == '지능기전공학과 무선이동체 18년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/18무선이동.png'
                    else if (dt1 == '지능기전공학과 무선이동체 19년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/19무선이동.png'
                    else if (dt1 == '지능기전공학과 무선이동체 20년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/지기전/20무선이동.png'
                    else if (dt1 == '컴퓨터공학과 16년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/컴공/컴공16.png'
                    else if (dt1 == '컴퓨터공학과 17년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/컴공/컴공17.png'
                    else if (dt1 == '컴퓨터공학과 18년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/컴공/컴공18.png'
                    else if (dt1 == '컴퓨터공학과 19년도 교과과정은 다음과 같습니다.')
                        path_img = '../asset/curriculum_img/컴공/컴공19.png'
                    /////////////////////////////////////////////////////////
                    // 졸업 요건
                    ////////////////////////////////////////////////
